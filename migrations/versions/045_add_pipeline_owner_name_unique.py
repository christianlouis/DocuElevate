...
def upgrade() -> None:
    ...
    if "uq_pipelines_owner_name" not in existing_indexes and "uq_pipelines_owner_name" not in existing_constraints:
...
def downgrade() -> None:
    ...
    if "uq_pipelines_owner_name" in existing_indexes:
        ...
        op.drop_constraint("uq_pipelines_owner_name", table_name="pipelines", type_="unique")
