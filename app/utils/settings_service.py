...
SETTING_METADATA = {
    ...
    "vector_index_enabled": {
        ...
        "description": "Enable chunk-level vector indexing and knowledge retrieval endpoints.",
        "type": "boolean",
        "sensitive": False,
        "required": False,
        "restart_required": True,
    ...
    "vector_index_url": {
        "category": "Knowledge Bridge",
        "description": "Internal Qdrant service URL.",
        "type": "string",
        "sensitive": False,
        "required": False,
        "restart_required": True,
    ...
    "vector_index_collection": {
        "category": "Knowledge Bridge",
        "description": "Qdrant collection containing derived document chunks.",
        "type": "string",
        "sensitive": False,
        "required": False,
        "restart_required": True,
    ...
    "vector_chunk_tokens": {
        "category": "Knowledge Bridge",
        "description": "Target token count for each indexed document chunk.",
        "type": "integer",
        "sensitive": False,
        "required": False,
        "restart_required": True,
    ...
    "vector_chunk_overlap_tokens": {
        "category": "Knowledge Bridge",
        "description": "Token overlap retained between adjacent document chunks.",
        "type": "integer",
        "sensitive": False,
        "required": False,
        "restart_required": True,
    ...
    "document_intake_shared_secret": {
        "category": "Knowledge Bridge",
        "description": "Dedicated secret accepted only from the controlled legacy intake sender.",
        "type": "password",
        "sensitive": True,
        "required": False,
        "restart_required": True,
    },
    "document_intake_shared_owner_id": {
        "category": "Knowledge Bridge",
        "description": "Principal and owner assigned to shared-secret document intake.",
        "type": "string",
        "sensitive": False,
        "required": False,
        "restart_required": True,
    },
    "document_bridge_enabled": {
        "category": "Knowledge Bridge",
        "description": "Forward completed documents to a remote DocuElevate intake endpoint.",
        "type": "boolean",
        "sensitive": False,
        "required": False,
        "restart_required": True,
    ...
    "document_bridge_url": {
        "category": "Knowledge Bridge",
        "description": "HTTPS URL of the destination document intake endpoint.",
        "type": "string",
        "sensitive": False,
        "required": False,
        "restart_required": True,
    ...
    "document_bridge_bearer_token": {
        "category": "Knowledge Bridge",
        "description": "Personal API token used by the outbound document bridge.",
        "type": "password",
        "sensitive": True,
        "required": False,
        "restart_required": True,
    ...
    "document_bridge_shared_secret": {
        "category": "Knowledge Bridge",
        "description": "Dedicated intake secret fallback for the outbound document bridge.",
        "type": "password",
        "sensitive": True,
        "required": False,
        "restart_required": True,
    },
    "document_bridge_source": {
        "category": "Knowledge Bridge",
        "description": "Provenance label attached to outbound document deliveries.",
        "type": "string",
        "sensitive": False,
        "required": False,
        "restart_required": True,
