...
- **mobile**: Bump vulnerable transitive packages
  ([#1226](https://github.com/christianlouis/DocuElevate/pull/1226),
  [`63160ac`](https://github.com/christianlouis/DocuElevate/commit/63160aca899230824899db9da154396bc0a25ea7))

### Build System

- **deps**: Bump fast-uri from 3.1.2 to 3.1.4 in /mobile
  ([#1214](https://github.com/christianlouis/DocuElevate/pull/1214),
  [`1e5163b`](https://github.com/christianlouis/DocuElevate/commit/1e5163bf0280043e7984fac618dcdff6f352e898))
...
- **deps**: Update boto3 requirement from >=1.43.51 to >=1.43.56
  ([#1217](https://github.com/christianlouis/DocuElevate/pull/1217),
  [`e30baa5`](https://github.com/christianlouis/DocuElevate/commit/e30baa589d3b607edcb1e5bad20b61c9dd11e655))

- **deps**: Update click requirement from >=8.0.0 to >=8.4.2
  ([#1223](https://github.com/christianlouis/DocuElevate/pull/1223),
  [`29c32ce`](https://github.com/christianlouis/DocuElevate/commit/29c32ce5e56a65ceaadbebdf6a89218267e5cad9))

- **deps**: Update dropbox requirement from >=11.36.0 to >=12.2.1
  ([#1219](https://github.com/christianlouis/DocuElevate/pull/1219),
  [`23517b0`](https://github.com/christianlouis/DocuElevate/commit/23517b0cd32f04ab4f7a5bba1f5b76eda68624f7))
...
- **deps**: Update google-auth requirement from >=2.22.0 to >=2.56.2
  ([#1224](https://github.com/christianlouis/DocuElevate/pull/1224),
  [`cbb3216`](https://github.com/christianlouis/DocuElevate/commit/cbb3216b45e5f96db01d70cd0f50d610368124c2))

- **deps**: Update msal requirement from >=1.20.0 to >=1.37.0
  ([#1215](https://github.com/christianlouis/DocuElevate/pull/1215),
  [`8b06968`](https://github.com/christianlouis/DocuElevate/commit/8b069683d98ca81599cf62ec75dc1d074781ba56))
...
- **deps**: Update redis requirement from >=8.0.0 to >=8.0.1
  ([#1221](https://github.com/christianlouis/DocuElevate/pull/1221),
  [`ff9a0a7`](https://github.com/christianlouis/DocuElevate/commit/ff9a0a76d0b67905ff965e51b9569a6568e7bc6e))

- **deps**: Update segno requirement from >=1.6.0 to >=1.6.6
  ([#1216](https://github.com/christianlouis/DocuElevate/pull/1216),
  [`cc4b0d1`](https://github.com/christianlouis/DocuElevate/commit/cc4b0d162c274b921721e096cfdba44855fcf02f))
...
- **deps**: Update strawberry-graphql requirement from <1.0.0,>=0.322.0 to >=0.323.2,<1.0.0
  ([#1218](https://github.com/christianlouis/DocuElevate/pull/1218),
  [`01ca2da`](https://github.com/christianlouis/DocuElevate/commit/01ca2daac77ca830c8ab2bf45a538084fbd018d1))

- **deps-dev**: Bump djlint from 1.36.4 to 1.42.3
  ([#1222](https://github.com/christianlouis/DocuElevate/pull/1222),
  [`a9db389`](https://github.com/christianlouis/DocuElevate/commit/a9db389d8508fa68b22ddc5d190fc2f6a33aa8f6))

- **deps-dev**: Bump postcss from 8.5.15 to 8.5.23 in /frontend
  ([#1225](https://github.com/christianlouis/DocuElevate/pull/1225),
  [`61696ba`](https://github.com/christianlouis/DocuElevate/commit/61696ba2be75b8e6e186daa58d1ee8a50facf707))

- **deps-dev**: Update fpdf2 requirement from >=2.8.0 to >=2.8.7
  ([#1220](https://github.com/christianlouis/DocuElevate/pull/1220),
  [`eda6f52`](https://github.com/christianlouis/DocuElevate/commit/eda6f52f14d8a1d8387767f58a58fbe775191009))
...
- **changelog**: Update changelog [skip ci]
  ([`f601df8`](https://github.com/christianlouis/DocuElevate/commit/f601df8d9ba665f1095930f588e481997a08cb92))

- **changelog**: Update changelog [skip ci]
  ([`850d6f5`](https://github.com/christianlouis/DocuElevate/commit/850d6f5730ce446125a9104db6860abf5e9a3e5a))

- **changelog**: Update changelog [skip ci]
  ([`68fdedd`](https://github.com/christianlouis/DocuElevate/commit/68fdeddc307102fafccebcd584138742321332d7))

- **changelog**: Update changelog [skip ci]
  ([`e7f570c`](https://github.com/christianlouis/DocuElevate/commit/e7f570c69d1205ee14bf5d523670e39396b27e0d))

- **changelog**: Update changelog [skip ci]
  ([`3874932`](https://github.com/christianlouis/DocuElevate/commit/38749320a638de20ca0494f6662ea9eceedd574c))

- **changelog**: Update changelog [skip ci]
  ([`0a81bd7`](https://github.com/christianlouis/DocuElevate/commit/0a81bd7aa95105ee6dee466bf983df7f5d38d682))

- **changelog**: Update changelog [skip ci]
  ([`dfba6fd`](https://github.com/christianlouis/DocuElevate/commit/dfba6fd4899645afef8f3b26765cca652b56707d))

- **changelog**: Update changelog [skip ci]
  ([`c7ede57`](https://github.com/christianlouis/DocuElevate/commit/c7ede57d160a5ccc108e231d068907f082a7eeeb))
...
- Include exact metadata in knowledge search
  ([#1071](https://github.com/christianlouis/DocuElevate/pull/1071),
  [`2a2396d`](https://github.com/christianlouis/DocuElevate/commit/2a2396d9469ff1460cce2e985ccf5a4bcd53f72e))
...
- Label images with release version
  ([#1069](https://github.com/christianlouis/DocuElevate/pull/1069),
  [`4e64212`](https://github.com/christianlouis/DocuElevate/commit/4e64212fdbdac53a0806b45528c78b3593e35004))
...
- Sync release and image versions ([#1068](https://github.com/christianlouis/DocuElevate/pull/1068),
  [`33e248e`](https://github.com/christianlouis/DocuElevate/commit/33e248e422729c5c0b9d914c8573d8df11da4844))
...
- Escape quotes in comment mentions
  ([#1035](https://github.com/christianlouis/DocuElevate/pull/1035),
  [`31fc45e`](https://github.com/christianlouis/DocuElevate/commit/31fc45e8aae5b98c3e5b10f87dd4f388caf7480f))
...
- **deps-dev**: Update python-semantic-release requirement
  ([#1023](https://github.com/christianlouis/DocuElevate/pull/1023),
  [`7c7d9d3`](https://github.com/christianlouis/DocuElevate/commit/7c7d9d3305afd3cc34b607fcb4880823c279f82a))
...
- **deps-dev**: Update types-requests requirement
  ([#1024](https://github.com/christianlouis/DocuElevate/pull/1024),
  [`7d64f83`](https://github.com/christianlouis/DocuElevate/commit/7d64f8393a164102d90a482a6005e01d887405a9))

### Documentation

- **changelog**: Update changelog [skip ci]
  ([`4fe20b7`](https://github.com/christianlouis/DocuElevate/commit/4fe20b7e3f741f44176cc76b29dab90f6f25c672))

- **changelog**: Update changelog [skip ci]
  ([`9c8c8fe`](https://github.com/christianlouis/DocuElevate/commit/9c8c8fe2fbefb34295524e8c8ef67a4b91519ade))

- **changelog**: Update changelog [skip ci]
  ([`017e3e2`](https://github.com/christianlouis/DocuElevate/commit/017e3e2d83f04a65e28ac4aaf46f229317a9c351))
...
- Complete webhook destination system
  ([`8ccae5c`](https://github.com/christianlouis/DocuElevate/commit/8ccae5c296aa1c456b6a9be510f7ecda2f658414))
...
## v0.173.12 (2026-07-06)

### Bug Fixes

- Clarify processing profiles ([#976](https://github.com/christianlouis/DocuElevate/pull/976),
  [`bebff61`](https://github.com/christianlouis/DocuElevate/commit/bebff610066f30e5e6dc53132e0a2b74f0d3f8a9))
...
- **changelog**: Update changelog [skip ci]
  ([`1e6a6f8`](https://github.com/christianlouis/DocuElevate/commit/1e6a6f82e5ab6e5f9f8527e18315336f240e3a14))
...
## v0.173.11 (2026-07-06)

### Bug Fixes

- Clean root artifacts and harden watch locks
  ([#972](https://github.com/christianlouis/DocuElevate/pull/972),
  [`e935bec`](https://github.com/christianlouis/DocuElevate/commit/e935becd3221b3b9c13d2a39c31e3ca7b92f7428))
...
- Harden semantic release pushes ([#971](https://github.com/christianlouis/DocuElevate/pull/971),
  [`d39b557`](https://github.com/christianlouis/DocuElevate/commit/d39b5573906cad39a84d50bd79dfa83b8991aec1))

- Serialize semantic release pushes ([#970](https://github.com/christianlouis/DocuElevate/pull/970),
  [`8c7f0f3`](https://github.com/christianlouis/DocuElevate/commit/8c7f0f36f7ca4834bfd1a3fa4888882a2a0f560a))

### Documentation

- **changelog**: Update changelog [skip ci]
  ([`f2493e8`](https://github.com/christianlouis/DocuElevate/commit/f2493e8e59d95c7a6ae89e05d19e6ed932d261a2))

- **changelog**: Update changelog [skip ci]
  ([`09e1425`](https://github.com/christianlouis/DocuElevate/commit/09e1425cab16a0f50ea2ff6e8e2bc8ea98ff376e))

- **changelog**: Update changelog [skip ci]
  ([`e78a4b1`](https://github.com/christianlouis/DocuElevate/commit/e78a4b1a9a653c60c72f9889dab068a2d254b622))
...
- Address additional Jules findings ([#950](https://github.com/christianlouis/DocuElevate/pull/950),
  [`92d640f`](https://github.com/christianlouis/DocuElevate/commit/92d640ff67d6e2837b242457fa9ea655b2008025))

- Address Jules code quality findings
  ([#950](https://github.com/christianlouis/DocuElevate/pull/950),
  [`92d640f`](https://github.com/christianlouis/DocuElevate/commit/92d640ff67d6e2837b242457fa9ea655b2008025))

- Address webhook and routing review
  ([#950](https://github.com/christianlouis/DocuElevate/pull/950),
  [`92d640f`](https://github.com/christianlouis/DocuElevate/commit/92d640ff67d6e2837b242457fa9ea655b2008025))

- Harden webhook host headers ([#950](https://github.com/christianlouis/DocuElevate/pull/950),
  [`92d640f`](https://github.com/christianlouis/DocuElevate/commit/92d640ff67d6e2837b242457fa9ea655b2008025))

- Satisfy webhook ci checks ([#950](https://github.com/christianlouis/DocuElevate/pull/950),
  [`92d640f`](https://github.com/christianlouis/DocuElevate/commit/92d640ff67d6e2837b242457fa9ea655b2008025))
...
- **deps**: Update apprise requirement from >=1.4.0 to >=1.11.0
  ([#946](https://github.com/christianlouis/DocuElevate/pull/946),
  [`323e854`](https://github.com/christianlouis/DocuElevate/commit/323e854474e381623cc52a61ea575a52b300cf16))
...
- **deps**: Update boto3 requirement from >=1.28.0 to >=1.43.36
  ([#939](https://github.com/christianlouis/DocuElevate/pull/939),
  [`c7a6342`](https://github.com/christianlouis/DocuElevate/commit/c7a6342847085c59f2cb73386a41b27553548ee2))
...
- **deps**: Update google-auth-oauthlib requirement
  ([#948](https://github.com/christianlouis/DocuElevate/pull/948),
  [`719096e`](https://github.com/christianlouis/DocuElevate/commit/719096e5d92d24b036fdcb0b983cb145696acbe8))

- **deps**: Update litellm requirement
  ([#941](https://github.com/christianlouis/DocuElevate/pull/941),
  [`37ceeb8`](https://github.com/christianlouis/DocuElevate/commit/37ceeb878093bb0e48ab8ce6c2184f3c6c9d25e2))
...
- **deps**: Update sentry-sdk requirement
  ([#947](https://github.com/christianlouis/DocuElevate/pull/947),
  [`f40499c`](https://github.com/christianlouis/DocuElevate/commit/f40499cf42abf56ad12a53f3aab9f8d0e3ce5270))

- **deps**: Update slowapi requirement from >=0.1.9 to >=0.1.10
  ([#944](https://github.com/christianlouis/DocuElevate/pull/944),
  [`de15c4e`](https://github.com/christianlouis/DocuElevate/commit/de15c4e4e259e331ed5ee114997cfd85ebc4bbfb))

- **deps-dev**: Update minio requirement from >=7.1.0 to >=7.2.20
  ([#942](https://github.com/christianlouis/DocuElevate/pull/942),
  [`6b46746`](https://github.com/christianlouis/DocuElevate/commit/6b467466de74473aedff4dfe02810caad26b40f2))
...
- **deps-dev**: Update pytest-timeout requirement
  ([#940](https://github.com/christianlouis/DocuElevate/pull/940),
  [`3ac7e85`](https://github.com/christianlouis/DocuElevate/commit/3ac7e85457f9cab31693f4e8acaaa2d2af6db9b7))

- **deps-dev**: Update types-aiofiles requirement
  ([#945](https://github.com/christianlouis/DocuElevate/pull/945),
  [`9370222`](https://github.com/christianlouis/DocuElevate/commit/9370222e79a9eb2267c9ed0526fe57b2160d0154))

### Code Style

- Apply ruff auto-fix ([#950](https://github.com/christianlouis/DocuElevate/pull/950),
  [`92d640f`](https://github.com/christianlouis/DocuElevate/commit/92d640ff67d6e2837b242457fa9ea655b2008025))

### Documentation

- **changelog**: Update changelog [skip ci]
  ([`e9b6bbb`](https://github.com/christianlouis/DocuElevate/commit/e9b6bbbdbd926c4e4e3cf00e6cc7e3c516027372))

- **changelog**: Update changelog [skip ci]
  ([`28b5c87`](https://github.com/christianlouis/DocuElevate/commit/28b5c87f0c4cb1a6e23d76f2e73e7e4feb87c9fb))

- **changelog**: Update changelog [skip ci]
  ([`285e713`](https://github.com/christianlouis/DocuElevate/commit/285e7137c922a171fa5e2e89d4076e5caeb92ce5))

- **changelog**: Update changelog [skip ci]
  ([`3ec7fc2`](https://github.com/christianlouis/DocuElevate/commit/3ec7fc22329dad8593f3a022c63299322cb5e83d))
...
- Cover automation samples and pending counts
  ([`a229514`](https://github.com/christianlouis/DocuElevate/commit/a2295146250cfa27bf80142b269d9fb18332b42b))
